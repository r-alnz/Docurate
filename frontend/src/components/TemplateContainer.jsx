...
`
  ...
  const dictionary = {
    whita: ["white", "whiter", "what"],
    awwada: ["awada", "award", "await"],
    awd: ["award", "add", "and"],
    tempalte: ["template", "temporal", "templar"],
    wdawd: ["award", "toward", "Edward"],
    teh: ["the", "tech", "ten"],
    adn: ["and", "add", "ado"],
    taht: ["that", "taut", "tact"],
    recieve: ["receive", "relieve", "reprieve"],
    seperate: ["separate", "desperate", "temperate"],
    definately: ["definitely", "defiantly", "defiant"],
    accomodate: ["accommodate", "accordant", "accordance"],
    occured: ["occurred", "obscured", "secured"],
    untill: ["until", "instill", "entail"],
    wierd: ["weird", "wired", "wield"],
    wich: ["which", "witch", "wish"],
    thier: ["their", "there", "they're"],
    reccomend: ["recommend", "recumbent", "recondite"],
    beleive: ["believe", "belive", "belief"],
    concious: ["conscious", "cautious", "copious"],
    foriegn: ["foreign", "foregone", "forlorn"],
    occassion: ["occasion", "occlusion", "occidental"],
    truely: ["truly", "cruelly", "cruelty"],
    buisness: ["business", "busyness", "brusqueness"],
    gaurd: ["guard", "gourd", "geared"],
    greatful: ["grateful", "grate", "great"],
    independant: ["independent", "indignant", "indigent"],
    knowlege: ["knowledge", "knoll", "known"],
    neccessary: ["necessary", "necessity", "necessitate"],
    persue: ["pursue", "peruse", "persuade"],
    preform: ["perform", "reform", "deform"],
    priviledge: ["privilege", "privileged", "privation"],
    recieve: ["receive", "relieve", "reprieve"],
    refered: ["referred", "refereed", "reference"],
    relevent: ["relevant", "relent", "reliant"],
    religous: ["religious", "religious", "religion"],
    rember: ["remember", "ember", "member"],
    resturant: ["restaurant", "restrain", "restart"],
    rythm: ["rhythm", "rhyme", "rime"],
    sieze: ["seize", "size", "sieve"],
    similer: ["similar", "simpler", "smiler"],
    sincerely: ["sincerely", "sincere", "sincerity"],
    suprise: ["surprise", "surmise", "sunrise"],
    tommorrow: ["tomorrow", "tomography", "tomfoolery"],
    tounge: ["tongue", "tong", "tone"],
    truely: ["truly", "cruelly", "cruelty"],
    unforseen: ["unforeseen", "unfrozen", "uniform"],
    unfortunatly: ["unfortunately", "unfortunate", "unformed"],
    untill: ["until", "instill", "entail"],
    vacume: ["vacuum", "volume", "value"],
    wether: ["whether", "weather", "wither"],
    wierd: ["weird", "wired", "wield"],
    writting: ["writing", "written", "witting"],
  }
