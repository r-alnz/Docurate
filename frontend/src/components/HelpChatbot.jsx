      ...
      <div className="fixed bottom-6 right-6 z-50">
        {!isOpen ? (
          <button
            ...
            className="h-14 w-14 rounded-full bg-[#38b6ff] hover:bg-[#2a9ed6] shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-105"
          >
            <HelpCircle className="h-6 w-6 text-white" />
          </button>
        ) : (
          <div className="bg-white rounded-lg shadow-xl w-[380px] overflow-hidden border border-gray-200">
          <div className="bg-gradient-to-r from-[#38b6ff] to-[#2a9ed6] p-4">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <h4 className="text-lg font-semibold text-white">
                    Ask Docurate
                  </h4>
                  <p className="text-sm text-white">Get AI-powered help</p>
                </div>
                <button
